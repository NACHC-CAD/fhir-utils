...
public class ValueSetUtil {
	...
	public static List<FhirResourceFile<ValueSet>> getValueSetFiles(File dir, boolean isRecursive) {
		List<FhirResourceFile<ValueSet>> valueSets = FhirFileReader.getFhirResourceFiles(dir, ValueSet.class, isRecursive);
		return valueSets;
	}
